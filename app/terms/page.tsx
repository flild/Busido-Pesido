      ...
      <div className="container max-w-[800px]">
        ...
        <div className="flex flex-col gap-8 text-coal/80 leading-relaxed">
          <section>
            ...
            <p className="mb-2">
              Данный документ является официальным предложением (публичной офертой) <strong>[УКАЗАТЬ ВАШЕ ФИО / ИП]</strong> (далее — Исполнитель) заключить договор на оказание информационно-консультационных услуг в области зоопсихологии и коррекции поведения животных на изложенных ниже условиях.
            </p>
