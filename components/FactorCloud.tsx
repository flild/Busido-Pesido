...
const factorDescriptions: Record<string, [string, string]> = {
  ...
  load: ["СУММАРНАЯ НАГРУЗКА", "Накопленная физическая, сенсорная и социальная нагрузка влияет на уровень возбуждения, восстановление. Поэтому реакция может зависеть от событий предыдущих дней."],
  ...
  contact: ["ВЗАИМОДЕЙСТВИЕ", "Способ взаимодействия человека с животным влияет на его чувство безопасности, уровень возбуждения и выбор поведения. Прикосновения, взгляд, дистанция, поводок, ограничения и последовательность действий."],
