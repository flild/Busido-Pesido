...
export function Footer() {
  return (
    <footer className="relative bg-coal text-white pt-[70px] pb-6 after:absolute after:inset-x-0 after:top-0 after:h-[7px]">
        ...
        <div>
          <div className="flex flex-col items-start gap-1 mb-4">
            ...
            <span className="text-[9px] uppercase tracking-[0.13em] text-white/60 font-[650]">
              Платформа благополучия животных
            </span>
          </div>
          <p className="text-oat max-w-[400px]">
            Здоровье, поведение, среда и обучение — части одной системы.
          </p>
        </div>
